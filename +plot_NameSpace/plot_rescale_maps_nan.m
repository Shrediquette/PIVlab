...
[currentimage,~]=import_NameSpace.import_get_img(2*currentframe-1);
...
converted_mask=mask_NameSpace.mask_convert_masks_to_binary(expected_image_size,mask_positions);
