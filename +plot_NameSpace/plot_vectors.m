...
if vecskip==1
	q=quiver(x(typevector==1),y(typevector==1),...
		(u(typevector==1)-(gui_NameSpace.gui_retr('subtr_u')/gui_NameSpace.gui_retr('calu')))*vecscale,...
		(v(typevector==1)-(gui_NameSpace.gui_retr('subtr_v')/gui_NameSpace.gui_retr('calv')))*vecscale,...
	...
	q2=quiver(x(typevector==2),y(typevector==2),...
		(u(typevector==2)-(gui_NameSpace.gui_retr('subtr_u')/gui_NameSpace.gui_retr('calu')))*vecscale,...
		(v(typevector==2)-(gui_NameSpace.gui_retr('subtr_v')/gui_NameSpace.gui_retr('calv')))*vecscale,...
	...
	q=quiver(x_reduced(typevector_reduced==1),y_reduced(typevector_reduced==1),...
		(u_reduced(typevector_reduced==1)-(gui_NameSpace.gui_retr('subtr_u')/gui_NameSpace.gui_retr('calu')))*vecscale,...
		(v_reduced(typevector_reduced==1)-(gui_NameSpace.gui_retr('subtr_v')/gui_NameSpace.gui_retr('calv')))*vecscale,...
		'Color', vectorcolor,'autoscale', 'off','linewidth',str2double(get(handles.vecwidth,'string')),'parent',target_axis);
	q2=quiver(x_reduced(typevector_reduced==2),y_reduced(typevector_reduced==2),...
		(u_reduced(typevector_reduced==2)-(gui_NameSpace.gui_retr('subtr_u')/gui_NameSpace.gui_retr('calu')))*vecscale,...
		(v_reduced(typevector_reduced==2)-(gui_NameSpace.gui_retr('subtr_v')/gui_NameSpace.gui_retr('calv')))*vecscale,...
		'Color', vectorcolorintp,'autoscale', 'off','linewidth',str2double(get(handles.vecwidth,'string')),'parent',target_axis);
	if str2num(get(handles.masktransp,'String')) < 100
