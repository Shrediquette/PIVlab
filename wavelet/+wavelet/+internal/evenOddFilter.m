function [Z,aset,bset] = evenOddFilter(x,hb,ha)
% This function is for internal use only, it may change or be removed in a
% future release.
%
% Z = wavelet.internal.evenOddFilter(x,hb,ha) filters the columns of x
...
% load qshift6;
% load woman;
% y = wavelet.internal.evenOddFilter(X,LoDa,LoDb);
...
% Nr is even
r2 = Nr/2;
Z = coder.nullcopy(zeros(r2,Nc,'like',x));
