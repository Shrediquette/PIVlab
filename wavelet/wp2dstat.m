...
switch option
    case 'create'
        ...
        %----------------------
        win_name = getWavMSG('Wavelet:wp1d2dRF:NamWinStatWP_2D');
        ...
        % Callbacks update.
        %------------------
        cba_sel_rec = @(~,~)wp2dstat('select', ...
            win_stats , ...
            rad_rec , ...
            infos_hdls ...
            );
        cba_sel_cfs = @(~,~)wp2dstat('select', ...
            win_stats , ...
            rad_cfs , ...
            infos_hdls ...
            );
        cba_edi_bin = @(~,~)wp2dstat('update_bins', ...
            win_stats , ...
            edi_bin , ...
            infos_hdls ...
            );
        cba_pus_sta = @(~,~)wp2dstat('draw', ...
            win_stats , ...
            win_caller , ...
            infos_hdls , ...
            node ...
        ...
        str_wintitle = getWavMSG('Wavelet:wp1d2dRF:Str_StatWinTit2',Img_Name,str_nb_val,depth,Wave_Name,Ent_Nam,str_par);
        ...
        if node>-1
            ...
            if size_img(1)<3 || size_img(2)<3
                wwarndlg(getWavMSG('Wavelet:commongui:Not_Enough',depth),...
                         getWavMSG('Wavelet:wp1d2dRF:NamWinStatWP_2D'),'modal');
            ...
            if node==-1
                str_title = getWavMSG('Wavelet:commongui:CompImg');
            elseif node==-2
                str_title = getWavMSG('Wavelet:commongui:DenoImg');
            end
        end
