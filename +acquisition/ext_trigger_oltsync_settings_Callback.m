...
if isempty(fh)
	...
	oltSync_GUI_window = figure('numbertitle','off','MenuBar','none','DockControls','off','Name','Trigger settings','Toolbar','none','Units','characters','Position', [mainpos(1)+mainpos(3)-35 mainpos(2)+15+4+4 35 9],'tag','oltSync_GUI_window','visible','on','resize','off');
	...
	item=[0 item(2)+item(4)+margin/2 parentitem(3) 5];
