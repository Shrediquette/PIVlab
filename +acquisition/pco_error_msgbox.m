...
uiwait(msgbox(['pco.matlab extension not found. Please follow the instructions in the wiki on github: ' newline 'https://github.com/Shrediquette/PIVlab/wiki/Setup-pco-cameras'],'modal'))
