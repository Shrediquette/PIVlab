...
rectangle(target_axis,'Position',roirect,'LineWidth',1,'LineStyle','-','edgecolor','b','tag','roiplot')
rectangle(target_axis,'Position',roirect,'LineWidth',1,'LineStyle',':','edgecolor','y','tag','roiplot')
