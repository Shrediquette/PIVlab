...
try
	...
	calu=gui_NameSpace.gui_retr('calu');
	...
	gui_NameSpace.gui_put('offset_x_true',offset_x_true);
	gui_NameSpace.gui_put('offset_y_true',offset_y_true);
	...
	if exist('pointscali','var')
		if ~isempty(pointscali)
			gui_NameSpace.gui_put('pointscali',pointscali);
		end
	end
catch
