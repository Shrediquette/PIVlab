...
%   - 1 : A bracketing line-search based on the strong Wolfe conditions (default for all other methods)
...
%   - 1 : Cubic interpolation/extrapolation using new function and gradient values
%   - 2 : Mixed quadratic/cubic interpolation/extrapolation (default)
%
