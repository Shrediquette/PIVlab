function [XGrid,YGrid,vHorz,vVert,Typevector]=RunMain(I0Org,I1Org,mask,roirect,eta,vartheta,MedFiltFlag,MedFiltSize,PyramidLevels)
...
if ~isfield(options,'Fmats')
    Fmats=wOFV.getFmatPyramid(M,PyramidLevels);
else
    Fmats=options.Fmats;
...
for k=1:mx
    ...
    for j=1:my
        ...
        [v1tmp,minOut(domnum),alphatmp]=wOFV.BayesPyd_sub(I0sub,I1sub,C,L,eta,varthetaSub,v0sub,...
