...
if str2double(get(handles.ac_interpuls,'String')) < gui_NameSpace.gui_retr('min_allowed_interframe')
	...
	set(handles.ac_interpuls,'String',num2str(gui_NameSpace.gui_retr('min_allowed_interframe')))
end
...
if alreadyconnected
	...
	acquisition_NameSpace.acquisition_control_simple_sync_serial(laser_running,0);
end
