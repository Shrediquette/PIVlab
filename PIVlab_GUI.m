...
if type==2 %NOT USED ANYMORE matlab file
    %xxx
    %채ndern, so dass immer nur eine datei gespeichert wird. entweder mit allen frames drin, oder nur mit einem.
...
if isempty(resultslist)==0
    if size(filepath,1)>0
        ...
        %man k철nnte erstmal alle frames stapeln, und danach nur die verwenden deren
        %nummer gew채hlt war.
