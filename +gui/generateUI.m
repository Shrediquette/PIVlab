...
handles.secondpeaktxt1 = uicontrol(handles.multip06,'Style','text','String','2nd-peak substituted','HorizontalAlignment','left', ...
...
uicontrol(handles.multip23,'Style','text','String','','Units','characters', ...
    ...
    'BackgroundColor',[0 0.8 1], ...
    'TooltipString','2nd-peak substituted vector color (fixed cyan — not user-configurable)');
handles.secondpeaktxt2=uicontrol(handles.multip23,'Style','text','String','2nd-peak substituted','HorizontalAlignment','left', ...
