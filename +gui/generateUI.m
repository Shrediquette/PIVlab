...
item=[0 item(2)+item(4) parentitem(3) 12];
handles.uipanel5 = uipanel(handles.multip02, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Region of interest','fontweight','bold');
...
handles.roi_select = uicontrol(handles.uipanel5,'Style','pushbutton','String','Select ROI','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @roi.select_Callback,'TooltipString','Draw a rectangle for selecting a region of interest');

item=[parentitem(3)/2 item(2) parentitem(3)/2 2];
handles.clear_roi = uicontrol(handles.uipanel5,'Style','pushbutton','String','Clear ROI','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @roi.clear_roi_Callback,'TooltipString','Remove the ROI');
...
item=[0 item(2)+item(4) parentitem(3)/2 1.5];
handles.mask_add_freehand = uicontrol(handles.uipanel25_1,'Style','pushbutton','String','Free hand','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', {@mask.add_Callback,'freehand'},'TooltipString','Add a freehand mask');

item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.mask_add_assisted = uicontrol(handles.uipanel25_1,'Style','pushbutton','String','Assisted f.h.','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', {@mask.add_Callback,'assisted'},'TooltipString','Add an assisted freehand mask');

item=[0 item(2)+item(4) parentitem(3)/2 1.5];
handles.mask_add_circle = uicontrol(handles.uipanel25_1,'Style','pushbutton','String','Circle','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', {@mask.add_Callback,'circle'},'TooltipString','Add a circular mask');

item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.mask_add_rectangle = uicontrol(handles.uipanel25_1,'Style','pushbutton','String','Rectangle','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', {@mask.add_Callback,'rectangle'},'TooltipString','Add a rectangular mask');

item=[0 item(2)+item(4) parentitem(3)/2 1.5];
handles.mask_add_polygon = uicontrol(handles.uipanel25_1,'Style','pushbutton','String','Polygon','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', {@mask.add_Callback,'polygon'},'TooltipString','Add a polygon mask');
...
handles.automask_preview = uicontrol(handles.uipanel25_2,'Style','pushbutton','String','Preview current frame','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.automask_preview_Callback,'TooltipString','Preview the automatically generated mask');

item=[0 item(2)+item(4) parentitem(3) 1.5];
handles.automask_generate_current = uicontrol(handles.uipanel25_2,'Style','pushbutton','String','Make mask for current frame','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.automask_generate_current_Callback,'TooltipString','Automatic generation of a mask for the current frame');

item=[0 item(2)+item(4) parentitem(3) 1.5];
handles.automask_generate_all = uicontrol(handles.uipanel25_2,'Style','pushbutton','String','Make mask for all frames','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.automask_generate_all_Callback,'TooltipString','Automatic generation of a mask for all frames');
...
handles.mask_display_average = uicontrol(handles.uipanel25_10,'Style','pushbutton','String','Display average','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.display_average_Callback,'TooltipString','Show the mean image');
...
item=[0+item(3) item(2) parentitem(3)/2 1.5];
handles.mask_combine = uicontrol(handles.uipanel25_9,'Style','pushbutton','String','Combine','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.combine_Callback,'TooltipString','Combine all overlapping masks of the current frame');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.mask_load = uicontrol(handles.uipanel25_6,'Style','pushbutton','String','Load mask(s)','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.load_Callback,'TooltipString','Load masks that were previously created in PIVlab');
...
handles.bg_save = uicontrol(handles.uipanel351,'Style','pushbutton','String','Save','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.bg_save_Callback,'TooltipString','Save the backgound image');

item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.bg_load = uicontrol(handles.uipanel351,'Style','pushbutton','String','Load','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.bg_load_Callback,'TooltipString','Load the backgound image');
...
handles.export_preprocess = uicontrol(handles.multip03,'Style','pushbutton','String','Export preview','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @export.preprocess_Callback,'TooltipString','Export the preprocessed image (use toggle button to switch between image A and B)');
...
handles.text11 = uicontrol(handles.uipanel41,'Style','text','units','characters','HorizontalAlignment','left','position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'String','Interrogation area [px]');
...
item=[0 0 0 0];
item=[0 item(2)+item(4)+margin/4 parentitem(3)/3*2 1];
handles.text129 = uicontrol(handles.uipanel42,'Style','text','units','characters','HorizontalAlignment','left','position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'String','Interrogation area [px]');
...
handles.clear_everything = uicontrol(handles.multip05,'Style','pushbutton','String','Clear all results','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @misc.clear_everything_Callback,'TooltipString','Clear all results');
...
handles.uipanel42x = uipanel(handles.multip06, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Velocity limits','fontweight','bold');
...
item=[0 item(2)+item(4) parentitem(3) 2];
handles.clear_vel_limit = uicontrol(handles.uipanel42x,'Style','pushbutton','String','Clear all velocity limits','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @validate.clear_vel_limit_Callback,'TooltipString','Remove the velocity limits');
...
item=[0 item(2)+item(4)+margin/4 parentitem(3) 2];
handles.restore_all = uicontrol(handles.multip06,'Style','pushbutton','String','Undo all validations (all frames)','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @validate.restore_all_Callback,'TooltipString','Remove all velocity filters for all frames');

item=[0 item(2)+item(4)+margin/2 parentitem(3) 1];
handles.amount_nans = uicontrol(handles.multip06,'Style','text','String','Valid detection probability (VDP): 100 %','HorizontalAlignment','center','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','amount_nans','TooltipString','Valid detection probability in percent');
...
handles.validtxt1 = uicontrol(handles.multip06,'Style','text','String','Valid vectors (1st peak)','HorizontalAlignment','left', ...
...
handles.rejectedtxt1=uicontrol(handles.multip06,'Style','text','String','Rejected / interpolated','HorizontalAlignment','left', ...
...
item=[0 item(2)+item(4)+margin/4 parentitem(3) 2];
handles.draw_line = uicontrol(handles.multip07,'Style','pushbutton','String','Pick reference length [px]','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @calibrate.draw_line_Callback,'TooltipString','Draw a line as distance reference in the image');
...
item=[0 item(2)+item(4)+margin parentitem(3) 2];
handles.apply_cali = uicontrol(handles.multip07,'Style','pushbutton','String','Apply calibration','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @calibrate.apply_cali_Callback,'TooltipString','Apply calibration to the whole session');
item=[0 item(2)+item(4)+margin*0.5 parentitem(3) 2];
handles.clear_cali = uicontrol(handles.multip07,'Style','pushbutton','String','Clear calibration','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @calibrate.clear_cali_Callback,'TooltipString','Remove calibration');
...
handles.uipanel37 = uipanel(handles.multip09,'Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Vector colors','fontweight','bold');
...
handles.uipanel27 = uipanel(handles.multip09, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Derived parameter appearance','fontweight','bold');
...
handles.uipanel27b = uipanel(handles.multip09, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Color legend','fontweight','bold');
...
item=[0 item(2)+item(4) parentitem(3)/2 2];
handles.save_polyline = uicontrol(handles.multip12,'Style','pushbutton','String','Save coords','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@extract.save_polyline_Callback,'TooltipString','Save poly line coordinates to *.mat file');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 2];
handles.clear_plot = uicontrol(handles.multip12,'Style','pushbutton','String','Clear data','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@extract.clear_plot_Callback,'TooltipString','Clear line / circle data');
...
handles.uipanel40 = uipanel(handles.multip13, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Distance & angle','fontweight','bold');

parentitem=get(handles.uipanel40, 'Position');
item=[0 0 0 0];

item=[0 item(2)+item(4)+margin/4 parentitem(3) 2];
handles.set_points = uicontrol(handles.uipanel40,'Style','pushbutton','String','Draw line','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@extract.set_points_Callback,'TooltipString','Draw a line to measure distance and angle');

item=[0 item(2)+item(4)+margin/2 parentitem(3)/3*2 1];
handles.text50 = uicontrol(handles.uipanel40,'Style','text','String','Delta x:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*2 1];
handles.text51 = uicontrol(handles.uipanel40,'Style','text','String','Delta y:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*2 1];
handles.text52 = uicontrol(handles.uipanel40,'Style','text','String','Length:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*2 1];
handles.text53 = uicontrol(handles.uipanel40,'Style','text','String','Angle to horiz. (deg):','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*2 1];
handles.text54 = uicontrol(handles.uipanel40,'Style','text','String','Angle to vert. (deg):','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
handles.uipanel39 = uipanel(handles.multip13, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Markers','fontweight','bold');

parentitem=get(handles.uipanel39, 'Position');
item=[0 0 0 0];

item=[0 item(2)+item(4)+margin/4 parentitem(3) 3];
handles.text146 = uicontrol(handles.uipanel39,'Style','text','String','Highlight points in the analyses. The markers will be memorized even if a new session is started.','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);

item=[0 item(2)+item(4) parentitem(3)/2 2];
handles.putmarkers = uicontrol(handles.uipanel39,'Style','pushbutton','String','Set markers','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@plot.putmarkers_Callback,'TooltipString','Click in the image to place markers. End by clicking the right mouse button');
...
handles.markers_display_average = uicontrol(handles.multip13,'Style','pushbutton','String','Display average','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @mask.display_average_Callback,'TooltipString','Show the mean image');
...
handles.text59 = uicontrol(handles.multip14,'Style','text','String','mean u:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*1 1];
handles.text60 = uicontrol(handles.multip14,'Style','text','String','mean v:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*1 1];
handles.text59a = uicontrol(handles.multip14,'Style','text','String','max u:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*1 1];
handles.text60a = uicontrol(handles.multip14,'Style','text','String','min u:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*1 1];
handles.text59b = uicontrol(handles.multip14,'Style','text','String','max v:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4) parentitem(3)/3*1 1];
handles.text60b = uicontrol(handles.multip14,'Style','text','String','min v:','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
item=[0 item(2)+item(4)+margin parentitem(3) 2];
handles.scatterplotter = uicontrol(handles.multip14,'Style','pushbutton','String','Scatter plot u & v','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@plot.scatterplotter_Callback,'TooltipString','Scatter plot u vs. v velocities');
...
item=[0 item(2)+item(4) parentitem(3) 2];
handles.generate_it = uicontrol(handles.multip15,'Style','pushbutton','String','Create images','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@simulate.generate_it_Callback,'TooltipString','Start particle simulation and create image pair');

item=[0 item(2)+item(4)+margin/4 parentitem(3) 2];
handles.save_imgs = uicontrol(handles.multip15,'Style','pushbutton','String','Save images','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@simulate.save_imgs_Callback,'TooltipString','Save current set of particle simulation images (e.g. if you want to import them to PIVlab)');
...
if ~isMATLABReleaseOlderThan("R2025a")
    handles.resolutionstring = uicontrol(handles.multip16,'Style','text','String','Image size (%)','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
else
    handles.resolutionstring = uicontrol(handles.multip16,'Style','text','String','Resolution (dpi)','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
end
item=[parentitem(3)/3*2 item(2) parentitem(3)/3 1];
if ~isMATLABReleaseOlderThan("R2025a")
...
item=[0 item(2)+item(4) parentitem(3)/2 2];
handles.save_area_coordinates = uicontrol(handles.multip17,'Style','pushbutton','String','Save coords','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@extract.save_polyline_Callback,'TooltipString','Save area coordinates to *.mat file');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 2];
handles.clear_plot_area = uicontrol(handles.multip17,'Style','pushbutton','String','Clear data','Units','characters', 'Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@extract.clear_plot_Callback,'TooltipString','Clear area data');
...
item=[0 0 0 0];
item=[0 item(2)+item(4) parentitem(3) 2];
handles.paraview_current = uicontrol(handles.multip19,'Style','pushbutton','String','Save current frame','Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@export.paraview_current_Callback,'TooltipString','Save current frame as Paraview file');
...
handles.paneltext2 = uicontrol(handles.multip21,'Style','text','String','If some button texts are clipped or not readable, try to increase the panelwidth here.','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);

item=[0 item(2)+item(4)+margin/2 parentitem(3) 3];
handles.paneltext2 = uicontrol(handles.multip21,'Style','text','String','Warning: Current results and settings will be cleared.','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);

item=[0 item(2)+item(4)+margin parentitem(3) 1];
handles.paneltext3 = uicontrol(handles.multip21,'Style','text','String','Change font size','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);

item=[0 item(2)+item(4) parentitem(3)/2 2];
handles.textsizeup = uicontrol(handles.multip21,'Style','pushbutton','String','Increase','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',{@gui.font_size_change,1},'TooltipString','Increase the text size of buttons etc.');

item=[parentitem(3)/2 item(2) parentitem(3)/2 2];
handles.textsizedown = uicontrol(handles.multip21,'Style','pushbutton','String','Decrease','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',{@gui.font_size_change,-1},'TooltipString','Decrease the text size of buttons etc');

item=[0 item(2)+item(4)+margin parentitem(3) 4];
handles.paneltext4 = uicontrol(handles.multip21,'Style','text','String','Please note: This setting will currently not be saved. Because otherwise this might screw up your user interface permanently.','Units','characters', 'HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);

item=[0 item(2)+item(4) parentitem(3) 2];
handles.flash_sync = uicontrol(handles.multip21,'Style','pushbutton','String','Flash firmware to synchronizer','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@gui.flash_sync_Callback,'TooltipString','Flash new firmware to OPTOLUTION synchronizer');

item=[0 item(2)+item(4)+margin parentitem(3) 2];
handles.detect_cam = uicontrol(handles.multip21,'Style','pushbutton','String','Detect connected cameras','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@acquisition.camera_info,'TooltipString','Detect connected cameras');

item=[0 item(2)+item(4)+margin parentitem(3) 2];
handles.detect_dongle = uicontrol(handles.multip21,'Style','pushbutton','String','Detect serial dongle','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@acquisition.serial_info,'TooltipString','Detect if driver for the dongle is installed');

item=[0 item(2)+item(4)+margin/4 parentitem(3) 2];
handles.test_sync = uicontrol(handles.multip21,'Style','pushbutton','String','Send test string (disable interlock!)','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback',@gui.test_sync_Callback,'TooltipString','Check all channels of the synchronizer (WARNING! Turn off interlocks!)');
...
handles.phase_meanmaker = uicontrol(handles.multip22,'Style','pushbutton', ...
    'String','Calculate phase mean','Units','characters', ...
    'Position',[item(1)+item(3) parentitem(4)-item(4)-margin-item(2) item(3)*2-margin item(4)], ...
    'Callback',@plot.phase_mean_Callback,'Tag','phase_meanmaker', ...
    'TooltipString','Calculate mean velocities for each oscillation phase and append extra frames with the results for one period');
% <--
...
handles.veccolor_valid_swatch2 = uicontrol(handles.multip23,'Style','text','String','','Units','characters', ...
    ...
    'TooltipString','Valid vector color — configurable in ''Modify plot appearance''');
handles.validtxt2 = uicontrol(handles.multip23,'Style','text','String','Valid vectors (1st peak)','HorizontalAlignment','left', ...
...
handles.veccolor_interp_swatch2 = uicontrol(handles.multip23,'Style','text','String','','Units','characters', ...
    ...
    'TooltipString','Rejected/interpolated vector color — configurable in ''Modify plot appearance''');
handles.rejectedtxt2 = uicontrol(handles.multip23,'Style','text','String','Rejected / interpolated','HorizontalAlignment','left', ...
...
item=[0 item(2)+item(4) parentitem(3) 10];
handles.uipanelac_general = uipanel(handles.multip24, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','General settings','fontweight','bold');
...
handles.ac_browse = uicontrol(handles.uipanelac_general,'Style','pushbutton','String','Browse...','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @acquisition.browse_Callback,'TooltipString','Browse for project folder. Images and configurations will be stored here.');

item=[0 item(2)+item(4)+margin*0.05 parentitem(3) 1];
handles.ac_configtxt = uicontrol(handles.uipanelac_general,'Style','text', 'String','Select configuration:','Units','characters', 'Fontunits','points','HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)]);
...
handles.uipanelac_laser = uipanel(handles.multip24, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Synchronizer control','fontweight','bold');
...
handles.ac_calibsnapshot = uicontrol(handles.uipanelac_calib,'Style','pushbutton','String','Snapshot','Units','characters', 'Fontunits','points','Position',[item(1)+margin*0.25 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2*0.25 item(4)],'Callback', @acquisition.camera_snapshot_Callback,'Tag','ac_calibsnapshot','TooltipString','Save current display','enable','on','interruptible','on','BusyAction','queue');
...
handles.calib_imagedata = uipanel(handles.multip26, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Calibration image data','fontweight','bold');
...
item=[0 item(2)+item(4)+margin/2 parentitem(3)/2 1.5];
handles.calib_saveparams = uicontrol(handles.calib_imagedata,'Style','pushbutton','String','Save parameters','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_saveparams_Callback,'TooltipString','Save the camera parameters to a file');

item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.calib_loadparams = uicontrol(handles.calib_imagedata,'Style','pushbutton','String','Load parameters','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_loadparams_Callback,'TooltipString','Load camera parameters from a file');

item=[0 item(2)+item(4)+margin/4 parentitem(3)/2 1.5];
handles.calib_clearparams = uicontrol(handles.calib_imagedata,'Style','pushbutton','String','Clear parameters','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_clearparams_Callback,'TooltipString','Clear camera parameters');
...
handles.rect_imagedata = uipanel(handles.multip27, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Rectification image data','fontweight','bold');
...
item=[0 item(2)+item(4)+margin/2 parentitem(3) 1.5];
handles.rect_load_imgs = uicontrol(handles.rect_imagedata,'Style','pushbutton','String','Load target image','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_rectification_loadimages_Callback,'TooltipString','Load an image of the calibration target aligned with your target coordinate system and inside the laser sheet.');

item=[0 item(2)+item(4)+margin/2 parentitem(3) 1.5];
handles.rect_show_points = uicontrol(handles.rect_imagedata,'Style','pushbutton','String','Show detected markers','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_rectification_show_points_Callback,'TooltipString','Show all points that can be detected');

item=[0 item(2)+item(4)+margin/2 parentitem(3) 1.5];
handles.rect_show_rectified = uicontrol(handles.rect_imagedata,'Style','pushbutton','String','Show rectified board','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_rectification_show_rectified_Callback,'TooltipString','Show a preview of the undistorted calibration board');

item=[0 item(2)+item(4)+margin/2 parentitem(3) 1.5];
handles.rect_show_cam_position = uicontrol(handles.rect_imagedata,'Style','pushbutton','String','Show camera position','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Callback', @preproc.cam_rectification_show_cam_position_Callback,'TooltipString','Show a 3D scene of camera and board position');
...
handles.calib_markersetup = uipanel(handles.multip28, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Properties','fontweight','bold');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.calib_rows = uicontrol(handles.calib_markersetup,'Style','edit','String','10','Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','calib_rows','TooltipString','Amount of rows of the checkerboard');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.calib_columns = uicontrol(handles.calib_markersetup,'Style','edit','String','18','Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','calib_columns','TooltipString','Amount of columns of the checkerboard');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.calib_checkersize = uicontrol(handles.calib_markersetup,'Style','edit','String','12','Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','calib_checkersize','TooltipString','Size of the checkers');
...
item=[parentitem(3)/2 item(2) parentitem(3)/2 1.5];
handles.calib_markersize = uicontrol(handles.calib_markersetup,'Style','edit','String','9','Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','calib_markersize','TooltipString','Size of the markers');
...
item=[0 item(2)+item(4) parentitem(3) 15];
handles.plot_correlation_matrices= uipanel(handles.multip29, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Properties','fontweight','bold');

parentitem=get(handles.plot_correlation_matrices, 'Position');
item=[0 0 0 0];

item=[0 item(2)+item(4)+margin/4 parentitem(3) 1.5];
handles.retrieve_correlation_matrices = uicontrol(handles.plot_correlation_matrices,'Style','pushbutton','String','Retrieve correlation matrices','Units','characters','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'TooltipString','Get correlation matrices for all passes for currently displayed frame','Callback', @plot.correlation_matrices_calculate);
