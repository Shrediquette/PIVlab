...
if ok==1
	...
	gui_NameSpace.gui_toolsavailable(0,'Busy, please wait...');drawnow;
	handles=gui_NameSpace.gui_gethand;
	...
	if currentwasmean==0
		tic;
		[image1,~]=import_NameSpace.import_get_img(selected);
		[image2,~]=import_NameSpace.import_get_img(selected+1);
		%if size(image1,3)>1
