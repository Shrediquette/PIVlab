function [XGrid,YGrid,vHorz,vVert,Typevector]=wOFVMain_Parallel_DatasetProc(I0Org,I1Org,mask,roirect,eta,vartheta,MedFiltFlag,MedFiltSize,PyramidLevels,Fmats,M)
