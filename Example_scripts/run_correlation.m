function [x,y,u,v,typevector, correlation_map] = run_correlation(image_dir, filenames1, filenames2, p, s, nr_of_cores, tform, tform_base)
...
%   Detailed explanation goes here
    ...
    if nr_of_cores > 1
	    ...
	    for i = 1:numel(x)  % index must increment by 1
		    [x{i}, y{i}, u{i}, v{i}, typevector{i}, correlation_map{i}] = ...
			    piv.piv_analysis(image_dir, filenames1{i}, filenames2{i},p,s,nr_of_cores,false, tform, tform_base);
            if i == 1
                disp("Processing: ")
            else
