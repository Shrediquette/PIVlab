...
% Check for updates
version=gui_NameSpace.gui_retr('PIVver');
...
gui_NameSpace.gui_put('update_msg_color',[0 0 0.75]);
try
	...
	if strcmp(version,web_version) == 1
		...
		gui_NameSpace.gui_put('update_msg_color',[0 0.75 0]);
