...
#define PCO_CLHS_DATAFORMAT_8_16    0x0002  //8bit padded to 16bit linesize

#define PCO_CLHS_DATAFORMAT_10P     0x0100  //raw with raw linesize
#define PCO_CLHS_DATAFORMAT_12P     0x0101  //raw with raw linesize
#define PCO_CLHS_DATAFORMAT_14P     0x0102  //raw with raw linesize

#define PCO_CLHS_DATAFORMAT_10P_16  0x0200  //raw padded to 16bit linesize
#define PCO_CLHS_DATAFORMAT_12P_16  0x0201  //raw padded to 16bit linesize
#define PCO_CLHS_DATAFORMAT_14P_16  0x0202  //raw padded to 16bit linesize
...
typedef void(* pco_image_done_cb_fn) (PCO_Image_cb *data);
