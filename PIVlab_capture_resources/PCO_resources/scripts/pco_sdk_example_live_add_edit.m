...
if(bitand(cam_desc.dwGeneralCapsDESC1,GENERALCAPS1_METADATA))
 subfunc.fh_set_metadata_mode(out_ptr,0);
	...
	[errorCode] = calllib('PCO_CAM_SDK', 'PCO_SetBinning', out_ptr,binning,binning); %2,4, etc.
	%ROI selection
	[errorCode] = calllib('PCO_CAM_SDK', 'PCO_SetROI', out_ptr,1,1,5120/binning,5120/binning); %does this work for the panda...?
