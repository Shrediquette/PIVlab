function [errorCode, ima] = pco_sdk_example_single_EDITED(exposure_time,triggermode)
...
if(bitand(cam_desc.dwGeneralCapsDESC1,GENERALCAPS1_NO_TIMESTAMP)==0)
 subfunc.fh_enable_timestamp(out_ptr,TIMESTAMP_MODE_OFF); %TIMESTAMP_MODE_BINARYANDASCII
end 
