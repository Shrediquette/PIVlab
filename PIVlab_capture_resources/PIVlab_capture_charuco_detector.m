...
if ~isempty(locs) && size(locs,3) == size(ids,1)
	...
	text(mean_loc_x,mean_loc_y,[num2str(percentage_detected) ' %'],'tag','charucolabel','Color','r','FontSize',36,'FontWeight','bold','HorizontalAlignment','center','VerticalAlignment','middle','Parent',figure_handle)
