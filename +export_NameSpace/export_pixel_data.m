...
if size(resultslist,2)>=1
	...
	if strmatch(get(handles.multip08, 'visible'), 'on')
		gui_NameSpace.gui_put('p8wasvisible',1)
	else
		gui_NameSpace.gui_put('p8wasvisible',0)
	end
	gui_NameSpace.gui_switchui('multip16');
else
...
export_NameSpace.export_still_or_animation_Callback()
