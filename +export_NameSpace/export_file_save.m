...
u(typevector==0)=NaN;
v(typevector==0)=NaN;
subtract_u=gui_NameSpace.gui_retr('subtr_u');
subtract_v=gui_NameSpace.gui_retr('subtr_v');
...
if type==1 %ascii file
	...
	if get(handles.export_vort, 'Value') == 1 %sollen alle derivatives exportiert werden?
		plot_NameSpace.plot_derivative_calc(currentframe,2,1); %vorticity
		plot_NameSpace.plot_derivative_calc(currentframe,3,1); %magnitude
		%u und v habe ich ja...
		plot_NameSpace.plot_derivative_calc(currentframe,6,1); %divergence
		plot_NameSpace.plot_derivative_calc(currentframe,7,1); %dcev
		plot_NameSpace.plot_derivative_calc(currentframe,8,1); %shear
		plot_NameSpace.plot_derivative_calc(currentframe,9,1); %strain
		plot_NameSpace.plot_derivative_calc(currentframe,11,1); %vectorangle
		derived=gui_NameSpace.gui_retr('derived');
