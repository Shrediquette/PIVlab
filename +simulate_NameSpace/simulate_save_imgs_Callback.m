...
gen_image_1=gui_NameSpace.gui_retr('gen_image_1');
gen_image_2=gui_NameSpace.gui_retr('gen_image_2');
real_displacement_u=gui_NameSpace.gui_retr('real_displ_u');
real_displacement_v=gui_NameSpace.gui_retr('real_displ_v');
