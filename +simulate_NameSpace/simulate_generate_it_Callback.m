...
gui_NameSpace.gui_put('gen_image_1',gen_image_1);
gui_NameSpace.gui_put('gen_image_2',gen_image_2);
gui_NameSpace.gui_put('real_displ_u',offsetx);
gui_NameSpace.gui_put('real_displ_v',offsety);
