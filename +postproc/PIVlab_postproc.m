...
function [u_out,v_out] = PIVlab_postproc (opts)
arguments
    opts.u
    opts.v
    opts.calu = 1
...
calu = opts.calu;
calv = opts.calv;
valid_vel = opts.valid_vel;
do_stdev_check = opts.do_stdev_check;
stdthresh = opts.stdthresh;
do_local_median = opts.do_local_median;
neigh_thresh = opts.neigh_thresh;
